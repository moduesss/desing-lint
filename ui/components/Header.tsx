...
type Props = { onRun: () => void; onExport: () => void; onSlack: () => void; onJira: () => void }
  ...
  return (
    <div className="sticky top-0 z-10 bg-white border-b border-gray-200 p-3 flex items-center justify-between">
      ...
      <div className="space-x-2">
        ...
        <button onClick={onSlack} className="px-3 py-1.5 rounded-md border">Copy Slack</button>
        <button onClick={onJira} className="px-3 py-1.5 rounded-md border">Copy Jira</button>
      </div>
    </div>
  )
}
